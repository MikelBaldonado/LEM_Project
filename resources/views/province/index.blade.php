...
<html lang="en">
    ...
    <body>
        ...
        <div class="d-flex">
            <div class="p-2 flex-grow-1"> <h1>List of Province</h1></div>
            <div class="p-2">
                ...
                <tbody>
                  ...
                  @foreach ($province as $item )
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="/province/{{$item->id}}/edit" class="btn btn-warning" style="width:100px;">Edit</a>
                          <form action="/province/{{$item->id}}" method='post'>
                            {{method_field('DELETE')}}
                            {!! csrf_field() !!}
